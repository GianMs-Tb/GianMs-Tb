...
|----------|---------------------|
| [**AI Operations Copilot**](https://github.com/GianMs-Tb/ai-operations-copilot-n8n) | Orquestación multi-canal con clasificación semántica LLM, context recovery en hilos Slack y enrutamiento Parent/Child a sub-workflows vía REST. |
| [**Secure Document Delivery Pipeline**](https://github.com/GianMs-Tb/secure-document-delivery-pipeline) | Pipeline ETL con OAuth impersonation, validation gates (circuit breaker), procesamiento binario PDF encriptado y multipart upload con auditoría. |
| [**Intelligent Follow-Up Engine**](https://github.com/GianMs-Tb/intelligent-follow-up-engine) | Motor de reglas con cooldown logic en PostgreSQL/Supabase, identity mapping multi-plataforma y guardrails de estado pre-envío. |
